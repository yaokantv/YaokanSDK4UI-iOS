...
//    YKRemoteMatchDeviceKey *key = self.matchDevice.matchKeys[indexPath.row];
    ...
    [YaokanSDK sendRemoteMatchingWithYkcId:[[YKCenterCommon sharedInstance] currentYKCId] matchDevice:_matchDevice cmdkey:key.key completion:^(BOOL result, NSError * _Nonnull error) {
...
- (IBAction)save:(id)sender {
    ...
    [YaokanSDK saveRemoteDeivceWithYKCId:[[YKCenterCommon sharedInstance] currentYKCId] matchDevice:_matchDevice completion:^(YKRemoteDevice * _Nonnull remote, NSError * _Nonnull error) {
