...
- (IBAction)powerOnAction:(id)sender {
    [YaokanSDK sendRemoteWithYkcId:[[YKCenterCommon sharedInstance] currentYKCId] remoteDevice:self.remote cmdkey:KeyPowerOn completion:^(BOOL result, NSError * _Nonnull error) {
...
- (IBAction)powerOffAction:(id)sender {
    ...
    [YaokanSDK sendRemoteWithYkcId:[[YKCenterCommon sharedInstance] currentYKCId] remoteDevice:self.remote cmdkey:KeyPowerOff completion:^(BOOL result, NSError * _Nonnull error) {
